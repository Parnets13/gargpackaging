...
const Banner = () => {
  ...
  return (
    <div className="mt-40 py-20" style={{ backgroundColor: "#c95e18" }}>
      <div className="mx-10 lg:flex lg:justify-between lg:items-center xl:mx-24">
        <div className="mx-auto">
          ...
          <p className="md:text-lg" style={{ color: "#45595b" }}>
            The generated Lorem Ipsum is therefore always free from repetition
            injected humour, or non-characteristic words etc.
          </p>
          <div
            className="buy py-3 px-12 border-2 rounded-full w-fit font-semibold duration-300 mt-4 mb-10"
            style={{ color: "#45595b" }}
          >
            <a href="">BUY</a>
          </div>
        ...
        <div className="relative md:mx-20">
          ...
          <div className="absolute top-0 left-0 bg-white rounded-full w-32 h-32 flex justify-center items-center">
            <span className="text-8xl font-bold" style={{ color: "#45595b" }}>
              1
            </span>
            <div className="flex flex-col py-10">
              <span className="text-2xl font-bold" style={{ color: "#45595b" }}>
                50₹
              </span>
              <span
